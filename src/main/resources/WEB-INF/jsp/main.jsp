...
<header th:fragment="header" class="site-header sticky-top py-1">
...
<main>
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            <h1 class="display-4 fw-normal">Tienda de Celulares</h1>
    ...
    <div th:fragment="item-light" class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
...
<footer th:fragment="footer" class="container py-5">
    <div class="row">
